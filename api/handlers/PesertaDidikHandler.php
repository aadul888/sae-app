        ...
        try {
            $stmt = $this->connection->prepare("
                ...
                (registrasi_id, jenis_pendaftaran_id, jenis_pendaftaran_id_str, nipd, tanggal_masuk_sekolah, 
                 sekolah_asal, alamat_jalan, peserta_didik_id, nama, nisn, jenis_kelamin, nik, tempat_lahir, tanggal_lahir,
                 ...
                 kurikulum_id, kurikulum_id_str, kebutuhan_khusus, is_sync_to_server, created_at, updated_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())
                ...
                kebutuhan_khusus = VALUES(kebutuhan_khusus), is_sync_to_server = VALUES(is_sync_to_server),
                updated_at = NOW()
            ");
