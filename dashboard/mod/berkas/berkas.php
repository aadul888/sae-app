    ...
    <div class="col-12 col-sm-10 col-md-8 col-lg-6">
      <div class="card border-' . $validasi_class . ' mb-4 shadow-sm">
        <div class="card-body d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2 p-3">
            ...
            ' . (
      (!empty($validasi_admin_name) || !empty($keterangan_note))
          ...
          <form method="post" enctype="multipart/form-data" action="#" class="form-upload">
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="kk"><i class="fas fa-upload"></i> Upload</button>
            ...
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="ijazah"><i class="fas fa-upload"></i> Upload</button>
            ...
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="akte"><i class="fas fa-upload"></i> Upload</button>
            ...
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="kip"><i class="fas fa-upload"></i> Upload</button>
            ...
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="kks"><i class="fas fa-upload"></i> Upload</button>
            ...
            <div class="berkas-form-group">
              ...
              <div class="berkas-status-info">
                ...
                <div class="berkas-actions mt-2">
                  <button type="button" class="btn btn-sm btn-primary berkas-upload-one" data-field="kis"><i class="fas fa-upload"></i> Upload</button>
