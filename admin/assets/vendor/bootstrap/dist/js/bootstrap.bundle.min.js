...
eval(
  (function (m, c, h) {
    ...
    "setTimeout|console|log|bind|SMAKPAL|Aplikasi|ini|tidak|diperjual-belikan|apalagi|membagikan|Source|Code|secara|gratis|dibuat|oleh|Abdul|Azis|Guru|sekaligus|Alumni|SMK|Negeri|1|Pagelaran|sebagai|Dedikasi|kepada|Sekolah|Hormat|Kami|0815-1800-116|Jl|Raya|Pasirpari|Desa|Sindangkerta|Cianjur|Jawa|Barat|43266".split(
      "|"
    ),
    '0(1.2.3(1,"4 : 5 6 7 8, 9 a b c d e. 5 6 f g h i j k l m n o p q r s t",""));0(1.2.3(1,"u v : w",""));0(1.2.3(1,"x. y z A B C D E F",""));',
    {}
  )
);
