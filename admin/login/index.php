...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style.css?v=<?php echo defined('SAE_VERSION') ? SAE_VERSION : '1.0.0'; ?>" type="text/css">
</head>
...
<body class="admin-login-page">
    ...
    <script src="./script.js?v=<?= defined('SAE_VERSION') ? SAE_VERSION : '1.0.0'; ?>"></script>
</body>
