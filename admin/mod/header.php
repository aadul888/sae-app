...
{
    return defined('SAE_VERSION') ? SAE_VERSION : (file_exists($path) ? filemtime($path) : time());
}
...
<div class="main-content" id="panel">
    ...
    <?php
    // Update check script dipindah ke footer.php (setelah sweetalert.min.js di-load)
    ?>
