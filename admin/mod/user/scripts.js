...
// Regenerate QR Code
$(document).on("click", ".btn-regenerate-qrcode", function () {
  swal(
    {
      title: "Generate Ulang Semua QR Code?",
      text: "Anda yakin ingin menghapus semua QR code yang ada dan membuat yang baru? Tindakan ini tidak dapat diurungkan.",
      type: "warning",
    ...
    function (isConfirm) {
      if (isConfirm) {
        swal({
          title: "Memproses...",
          text: "Sedang menghapus file QR code, mohon tunggu.",
          closeOnClickOutside: false,
          buttons: false,
        });
        $.ajax({
          url: "./mod/user/regenerate_qrcode.php",
          type: "POST",
          dataType: "json",
