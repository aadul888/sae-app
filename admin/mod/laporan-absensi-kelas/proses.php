        ...
        <nav>
          ...
          $result_pagination = $connection->query($query_pagination);
            ...
            $jumPage = ceil($jumData/$limit);
                ...
                if ($halaman > 1){echo '<li class="page-item"><a class="page-link btn-pagination" href="javascript:void(0);" data-id="'.($halaman-1).'">Â«</a></li>';}
                ...
                if ($halaman < $jumPage){echo'<li class="page-item"><a class="page-link btn-pagination" href="javascript:void(0);" data-id="'.($halaman+1).'">Â»</a></li>';
                }
