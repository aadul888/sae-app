...
default:
// Stat
$stat_total_kriteria = 0;
$q_stat = $connection->query("SELECT COUNT(*) AS total FROM poin_kriteria");
if ($q_stat) $stat_total_kriteria = intval($q_stat->fetch_assoc()['total']);
echo'
<!-- Header -->
...
<div class="container-fluid mt--6 user-module-page">
  ...
  <div class="row"><div class="col-12"><div class="card user-stats-panel module-stats-shell mb-3"><div class="card-body py-2 px-2 px-md-3"><div class="user-stats-wrap"><div class="user-stats module-stats-grid">
    <div class="module-stat-card user-stat-total"><div class="info"><span class="label">Total Kriteria</span><span class="value">'.$stat_total_kriteria.'</span></div><div class="icon"><i class="fas fa-clipboard-list"></i></div></div>
      ...
      <div class="card user-table-panel module-table-card pb-2">
        <div class="card-header py-3 px-3 module-table-header">
          <div class="module-header-row" style="gap:10px;">
            <div><h4 class="mb-1">Kriteria PIP</h4><small class="text-muted">Atur kriteria kelayakan penerima PIP.</small></div>
