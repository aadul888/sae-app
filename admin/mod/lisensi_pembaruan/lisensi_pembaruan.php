...
if (!isset($_COOKIE['ADMIN_KEY']) && !isset($_COOKIE['KEY'])) {
  ...
  if ($has_access) {
    ...
    // $api_debug_log = $_SESSION['api_debug_log'] ?? null; // Debug code removed
        ...
        <div class="card-body pb-0">
          <ul class="nav nav-pills nav-fill flex-column flex-md-row tab-responsive" id="tabs-icons-text" role="tablist">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link mb-sm-3 mb-md-0" href="#tabs-notif" onclick="loadTab(3);" role="tab" aria-controls="tabs-notif" aria-selected="false">
                <i class="fas fa-bell mr-2"></i>
                Notifikasi
                <span id="notifBadge" class="badge badge-danger ml-1" style="display:none;">0</span>
              </a>
            </li>          </ul>
        </div>
