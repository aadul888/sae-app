        ...
        <div class="col-12">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label form-control-label font-weight-bold">Alamat</label>
                <div class="col-md-9">
                  <textarea class="form-control" rows="3" name="site_address" required>' . strip_tags($site_address) . '</textarea>
                  <small class="form-text text-muted">Alamat lengkap institusi</small>
                </div>
              </div>
