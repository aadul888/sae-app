...
<div class="container-fluid mt--6 user-module-page">
  ...
  <form class="form-add" role="form" action="#" enctype="multipart/form-data">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Update Kode/Logo Jurusan <span class="modal-title-name text-info"></span></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label>Kode Jurusan</label>
              <input type="text" class="form-control jurusan-kode" name="kode_jurusan" maxlength="20" required>
              <small class="form-text text-muted">Kode bisa disesuaikan untuk singkatan (contoh: ATPH, KHT, TKJ).</small>
            </div>
            <div class="form-group">
              <label>Nama Jurusan</label>
              <input type="text" class="form-control jurusan-nama" name="nama_jurusan" readonly>
            </div>
            <div class="form-group">
              <label>Logo Jurusan (PNG, max 1MB, opsional)</label>
