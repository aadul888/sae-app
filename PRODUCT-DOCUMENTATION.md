...
| **Privasi & Kebijakan** | `./tentang?tab=privasi` | Kebijakan privasi dan ketentuan penggunaan sistem (digabung di halaman Tentang) |
...
> _(Tambahkan screenshot di bawah ini)_
...
> **Demo Online:** _(Tambahkan URL demo)_
...
| Channel      | Detail                 |
| :----------- | :--------------------- |
| **Website**  | _(Tambahkan URL)_      |
| **Email**    | _(Tambahkan email)_    |
| **WhatsApp** | _(Tambahkan nomor)_    |
| **Demo**     | _(Tambahkan URL demo)_ |
...
_Dokumen ini dibuat secara otomatis berdasarkan analisis kode sumber SAE v5. Terakhir diperbarui: Mei 2026._
