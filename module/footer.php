<?php if (empty($connection)) {
  ...
  $is_fullpage_module = in_array($module_root_footer, ['home', 'absensi', 'realtime', 'agenda', 'tentang', 'login', 'nisn', 'registrasi', 'tamu']);
        ...
        <div class="col-12">
          <div class="copyright text-center module-footer-copy">
            <span class="text-muted small module-footer-links">
              ...
              <span>|</span>
              <span>Developed by <a href="https://s.id/smakpalapik" target="_blank" class="text-primary">SMAKPALAPIK</a></span>
            </span>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="copyright text-center">
            <div class="d-flex align-items-center justify-content-center flex-wrap">
              ...
              <span class="text-muted small">
                Developed by <a href="https://s.id/smakpalapik" target="_blank" class="text-primary font-weight-500">SMAKPALAPIK</a>
              </span>
            </div>
          </div>
        </div>
  ...
  <?php echo '
    <script src="' . $base_url . 'module/assets/vendor/jquery/dist/jquery.min.js"></script>
    <script src="' . $base_url . 'module/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="' . $base_url . 'module/assets/vendor/js-cookie/js.cookie.js"></script>
    <script src="' . $base_url . 'module/assets/vendor/jquery.scrollbar/jquery.scrollbar.min.js"></script>
    <script src="' . $base_url . 'module/assets/vendor/jquery-scroll-lock/dist/jquery-scrollLock.min.js"></script>
    <!-- Optional JS -->
    <script src="' . $base_url . 'module/assets/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="' . $base_url . 'module/assets/vendor/Magnific-Popup/jquery.magnific-popup.min.js"></script>
  ...
  $js_version = filemtime($module_script);
  echo '    <script src="' . $base_url . $script_path . '?v=' . $js_version . '"></script>';
  echo '
</body>
</html>';
}
