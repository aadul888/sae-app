...
if (empty($connection)) {
  ...
  if (file_exists($login_logo_path)) {
    $login_logo_src .= '?v=' . filemtime($login_logo_path);
  }
          ...
          <div class="col-12">
            <div class="login-card auth-login-card h-100 auth-login-card--single">
              <div class="login-header">
                ...
                <h2 class="app-title">Pilih Jalur Login</h2>
              </div>
              <div class="login-form-container">
                <div class="login-type-tabs">
                  <button type="button" class="login-type-tab active" id="tabMurid" onclick="switchLoginTab('murid')" aria-selected="true">
                    <i class="fas fa-user-graduate me-2" aria-hidden="true"></i>Login Murid
                  </button>
                  <button type="button" class="login-type-tab" id="tabAdmin" onclick="switchLoginTab('admin')" aria-selected="false">
                    <i class="fas fa-user-shield me-2" aria-hidden="true"></i>Login Admin
                  </button>
                </div>
                ...
                <div id="loginPaneAdmin" class="login-pane" style="display:none;">
                  <p class="login-pane-copy">Masuk ke panel administrasi <?php echo htmlspecialchars($login_site_name); ?> menggunakan akun operator, guru, atau pengelola sistem yang sudah terdaftar.</p>
                  <div class="admin-login-info">
                    <div class="admin-login-icon">
                      <i class="fas fa-user-shield" aria-hidden="true"></i>
                    </div>
                    <p class="mb-1">Panel admin menggunakan sistem autentikasi terpisah.</p>
                    <p class="mb-0">Pastikan Anda memiliki akun administrator yang valid sebelum melanjutkan.</p>
                  </div>
                  <a href="<?php echo htmlspecialchars($admin_url); ?>" class="btn-login d-inline-flex align-items-center justify-content-center text-decoration-none auth-admin-button">
                    <span class="btn-text">Masuk ke Panel Admin</span>
                    <i class="fas fa-arrow-right btn-icon ms-2" aria-hidden="true"></i>
                  </a>
                </div>
