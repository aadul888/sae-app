...
$home_logo_v = defined('SAE_VERSION') ? SAE_VERSION : ($commit_hash ?? '1.0.0');
$home_logo_src = (isset($base_url) ? $base_url : './') . 'content/' . $home_logo_file . '?v=' . substr((string)$home_logo_v, 0, 16);
...
$public_fullpage_modules = ['home', 'absensi', 'realtime', 'agenda', 'tentang', 'kelulusan', 'login', 'nisn', 'konfigurasi', 'tamu'];
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $base_url; ?>module/assets/css/style.css?v=<?php echo defined('SAE_VERSION') ? SAE_VERSION : '1.0.0'; ?>" type="text/css">
...
<body class="<?php echo trim($body_class . ($is_fullpage ? ' layout-fullpage' : '')); ?>">
  ...
  <div class="main-content"><?php
      if ($module_root_name === 'konfigurasi'):
    ?>
    <?php
